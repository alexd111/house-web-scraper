...
def get_rightmove_houses(url):
    ...
    for item in soup_list:
        ...
        house = accommodation.Accommodation(price, bedrooms, "UNSURE", is_furnished, link)
...
def init_db():
    ...
    c.execute('''CREATE TABLE IF NOT EXISTS accomodations
...
def add_house_to_db(house):
    ...
    c.execute('INSERT INTO accomodations VALUES (?,?,?,?,?,?,?)', row)
